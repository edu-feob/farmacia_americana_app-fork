...
class AttendantChatItem extends StatelessWidget {
  ...
  const AttendantChatItem({super.key, required this.chat});
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      chat.timestamp,
                      style: TextStyle(
                        color: chat.isUrgent ? Pallete.primaryRed : const Color(0xFF94A3B8),
                        fontWeight: chat.isUrgent ? FontWeight.w700 : FontWeight.w600,
                      ),
                    ),
                  ],
                ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: chat.isPositive ? const Color(0xFF059669) : const Color(0xFF516B8B),
                    fontSize: 10,
                    fontStyle: chat.isPositive ? FontStyle.normal : FontStyle.italic,
                  ),
                ),
              ],
            ),
