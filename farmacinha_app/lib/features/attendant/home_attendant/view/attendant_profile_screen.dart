      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: const Icon(Icons.notifications, color: Color(0xFF111111), size: 30),
          ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Farmacêutico Responsável - CRM 12345',
              ...
              TextButton.icon(
                onPressed: () {},
                icon: const Icon(Icons.logout_rounded, color: Pallete.primaryRed, size: 29),
                label: const Text(
                  'Sair da Conta',
                  style: TextStyle(
                    color: Pallete.primaryRed,
          ...
          child: SizedBox(
            ...
            child: Row(
              children: [
                ...
                const Icon(Icons.chevron_right_rounded, color: Color(0xFFD0D0D0), size: 36),
              ],
            ),
          ),
        ),
